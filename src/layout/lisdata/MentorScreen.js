...
import { Text, View, FlatList, Image, Button, TouchableHighlight, TouchableWithoutFeedback, ActivityIndicator, Alert, RefreshControl } from 'react-native'
	...
	useEffect(() => {
		axios.get('http://newsapi.org/v2/top-headlines?country=id&category=health&apiKey=266d190c4442467880148c3565390825')
			.then(res => {
				...
				setNews(news, setIsLoading(false), setRefreshing(false))
				console.log(newsku)
			})
	}, [])
	getData = (() => {
